...
model_urls = {
    ...
    "resnet101": "/utils/pretrained/resnet101.pth",
...
def resnet101(pretrained=True, pretrain_model_url="./pretrained/resnet101.pth", **kwargs):
    ...
    if pretrained:
        if pretrain_model_url is None:
            ...
            model_url = pretrain_model_url
        state_dict = torch.load('./utils/pretrained/resnet101.pth')
