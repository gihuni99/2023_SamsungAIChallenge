...
# 1. Adam <-> SGD 실험
# 2. Weight decay 적용, 하이퍼파라미터 0.1~0.5? 아마
# 3. 기하학적 증강(Rotation, Perspective, fisheye 변환 등. 최대한 Target에 학습될수있도록)
# 4. 광학적 증강 조금 손을 대보고
# 5. Drop out << 코드한줄. segformer.py
# 6. wandb로 대충 10epoch
...
optimizer = torch.optim.Adam(student_model.parameters(), lr=args.lr, weight_decay=0.1)
